...
const projectsData = [
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/1.png`,
    tag: ["All", "Web","Mobile"],
  ...
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/2.png`,
    tag: ["All", "Web","Mobile"],
    gitUrl: "/",
  ...
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/3.png`,
    tag: ["All", "Mobile"],
    gitUrl: "/",
  ...
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/4.png`,
    tag: ["All", "Mobile"],
    gitUrl: "/",
  ...
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/5.png`,
    tag: ["All", "Web"],
    gitUrl: "/",
    previewUrl: "/",
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_WEB_APP_DOMAIN}images/projects/6.png`,
    tag: ["All", "Mobile"],
    gitUrl: "/",
